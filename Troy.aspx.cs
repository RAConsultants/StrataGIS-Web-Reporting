...
public partial class Troy: System.Web.UI.Page
{
    ...
    protected void btnSearchDaily_Click(object sender, EventArgs e)
    {
        ...
        dataConn.Open();
        string sqlquery = "select Replace(Convert(date,Date),' 12:00:00 AM','') as Date, Department as Dpt, VehicleId as Vehicle, HoursRunning as HrsRun, HoursIdle as HrsIdle, HoursOff as HrsOff, DIHours as DIHrs, round(TotalMiles,2) as Miles, AvgSpeed, round(MaxSpeed,2) as MaxSpeed, OnTime as OnTime, OffTime as OffTime, MILCodes ";
